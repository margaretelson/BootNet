...
function SinupForm(props) {
    return (
        ...
        <form>
          <div class="field">
            <div class="control">
              <input class="input is-medium" type="text" placeholder="Name" name="name" value={props.userInfo.name}
          ...
          <div class="field">
            <div class="control">
              <input class="input is-medium" type="email" placeholder="Email" name="email" value={props.userInfo.email}
                onChange={props.handleInputChange}
                placeholder="Email"/>
            </div>
          </div>
          <div class="field">
            <div class="control">
              <input class="input is-medium" type="email" placeholder="username" name="username" value={props.userInfo.email}
                onChange={props.handleInputChange}
          ...
          <button class="button is-block is-info is-fullwidth is-medium">Sign Up</button>
          <br />
